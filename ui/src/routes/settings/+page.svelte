...
<form on:submit|preventDefault={doSaveSettings}>
	<FormGroup>
		...
		<Input id="hostname" bind:value={config.hostname} pattern="^[a-zA-Z][a-zA-Z\d\-]{'{'}1,30{'}'}[a-zA-Z\d]$" placeholder="changeme" minlength="3" maxlength="32" />
	</FormGroup>
	<FormGroup>
	...
	<Button block style="height: 5rem;"><Fa icon={faFloppyDisk} />&nbsp;Save Settings</Button>
</form>
